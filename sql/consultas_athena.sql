...
--    Na execucao do laboratorio o registro foi feito pelo crawler tc3-crawler-gold,
--    que percorre s3://<bucket>/gold/ e cria as quatro tabelas no banco workspace.
--    O DDL abaixo e a alternativa manual, equivalente e util para reproduzir o
--    catalogo sem depender do crawler. Executar uma unica vez, apos o Glue Job 02.

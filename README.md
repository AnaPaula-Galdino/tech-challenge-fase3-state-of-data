...
**Print AWS:** [print aws]([entregaveis/TechChallenge_Fase3_MaterialExecutivo.pdf])
---
...
O diagrama foi construído no Draw.io, como o enunciado exige. O arquivo editável está em `entregaveis/arquitetura_aws.drawio`, a imagem exportada em `entregaveis/arquitetura_aws.png`, e ele também aparece dentro do material executivo, no slide 5.
...
- 237 colunas de pergunta existem nas três edições, e 92 delas mudaram de código. São descrições de coluna, o que inclui as sub-opções das perguntas de múltipla escolha.
...
├── figuras/                      gráficos gerados por src/graficos.py, em alta resolução

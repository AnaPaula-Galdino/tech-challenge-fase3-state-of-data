...
pres.subject = "Tech Challenge Fase 3, POSTECH Data Analytics, FIAP";
pres.company = "FIAP, POSTECH Data Analytics";
...
function slideGrafico(kicker, titulo, imagem, leitura, fonte) {
  ...
  // sem altText explicito a biblioteca grava o caminho do arquivo no texto
  // alternativo da imagem, o que expoe a estrutura de pastas de quem gerou
  s.addImage({ path: FIG_DECK(imagem), x: 0.5, y: 1.62, w: 8.64, h: 4.8, altText: titulo });
...
// =====================================================================
{
  ...
  const itens = [
    { n: "60,6%", t: "dos respondentes dizem que a empresa prioriza IA generativa", d: "Eram 36,2% duas edições atrás. Apenas 26,5% declaram projetos em produção gerando resultado." },
...
// =====================================================================
{
  const s = slideConteudo("Os dados", "Três edições, mais de mil colunas, uma base que não se une sozinha");
  const nums = [
...
// =====================================================================
{
  ...
  // caixa proporcional ao PNG exportado do Draw.io (4536 x 1806), para nao esticar a imagem
  s.addImage({ path: FIG_DECK("arquitetura_aws.png"), x: 0.57, y: 1.80, w: 12.2, h: 4.86,
    altText: "Diagrama da arquitetura da solução na AWS, do arquivo de origem no Kaggle até o material executivo, passando pelas camadas Bronze, Silver e Gold no Amazon S3, pelos dois jobs do AWS Glue em PySpark, pelo Glue Data Catalog e pelo Amazon Athena." });
  rodape(s, "Diagrama construído e exportado no Draw.io. O arquivo editável .drawio acompanha a entrega.");
...
// =====================================================================
{
  ...
  s.addText("Só entra na série histórica a coluna aprovada nos três critérios. O mapa completo das 237 colunas equivalentes acompanha a entrega.",
  ...
  s.addNotes("Sem essa regra, toda a série histórica seria inválida sem que ninguém percebesse. Não correr neste slide.");
}
...
slideGrafico("Estrutura do mercado",
  ...
  [
    ...
    { titulo: "O que não muda com a região", texto: "A faixa salarial mediana é R$ 10.000 nas cinco regiões, sem exceção. Contratar fora do Sudeste amplia o alcance, mas não reduz o custo por profissional." },
  ]);
...
slideGrafico("Perfis valorizados",
  ...
  [
    ...
    { titulo: "A decisão que isso força", texto: "O preço da senioridade pronta subiu 40% e o do Pleno permaneceu inalterado. Formar internamente ficou relativamente mais barato do que disputar um profissional Sênior no mercado." },
...
slideGrafico("Perfis valorizados",
  ...
  [
    { titulo: "Quem o mercado paga melhor", texto: "O cargo de ML e AI Engineer lidera, com mediana de R$ 18.000. Engenharia e Arquitetura de Dados, Analytics Engineer e Data Product Manager vêm em seguida, todos em R$ 14.000." },
    { titulo: "A distância dentro da área", texto: "Analista de Dados, de BI e de Negócios ficam em R$ 7.000, metade da mediana dos cargos de engenharia. O rótulo genérico de profissional de dados esconde uma diferença de duas vezes entre as pontas." },
  ...
  "Fonte: State of Data Brazil, edição 2025-2026. Omitidos os cargos com menos de 30 respostas e a categoria Outra Opção, com 206 respostas. Valores nominais.");
...
slideGrafico("Diversidade de gênero",
  ...
  [
    { titulo: "O funil aperta na senioridade", texto: "Entre as mulheres, 25,7% estão no nível Júnior, contra 19,1% entre os homens. No Sênior a relação se inverte, 31,4% contra 35,2%." },
...
slideGrafico("Tecnologias",
  "Python lidera nas três edições, e o SQL aparece ao lado dele em 2025-2026",
  "fig07_linguagens.png",
  [
    { titulo: "Stack estável", texto: "Python é a linguagem mais citada nas três edições, entre 88,0% e 92,0%, sem concorrente próximo enquanto a pergunta admitia uma só resposta." },
    { titulo: "Cuidado na leitura", texto: "O salto do SQL, de 2,1% para 84,2%, vem da mudança de formato: em 2025-2026 a pergunta passou a aceitar várias respostas. Não é crescimento de mercado. Por isso a métrica é a menção, e a soma supera 100% naquela edição." },
  ],
  "Fonte: State of Data Brazil. Percentual de respondentes que citam a linguagem como preferida.");

slideGrafico("Tecnologias",
  "AWS lidera na nuvem e o Power BI lidera em BI, mas um terço não tem preferência",
  "fig13_ferramentas.png",
  [
    { titulo: "Nuvem", texto: "AWS é citada por 31,7% dos 2.095 que responderam, à frente de Google Cloud, com 20,6%, e Azure, com 14,7%. Considerando apenas quem declara preferência, a AWS chega a 47,0%." },
    { titulo: "Visualização", texto: "Power BI é citado por 50,5% dos 1.866 que responderam, cinco vezes o segundo colocado, e chega a 65,6% entre quem declara preferência." },
    { titulo: "O que a pergunta mede", texto: "A pesquisa pergunta preferência, não uso. Um terço não tem preferência de nuvem, o que sugere decisão tomada acima do profissional. A solução deste projeto roda em AWS, a nuvem com mais gente pronta no mercado." },
  ],
  "Fonte: State of Data Brazil, edição 2025-2026. Bases de 2.095 e 1.866 respostas. Percentuais sobre o total que respondeu, incluindo quem não declara preferência.");

slideGrafico("Adoção de inteligência artificial",
  "A prioridade declarada da IA cresceu dois terços e a rejeição caiu mais da metade",
  "fig06_ia_serie.png",
  [
    { titulo: "A maior mudança do período", texto: "A prioridade declarada passou de 36,2% para 60,6% em duas edições, alta de 68%, e a rejeição caiu de 28,8% para 11,3%, queda de 61%. Nenhum outro indicador se moveu tanto." },
...
slideGrafico("Adoção de inteligência artificial",
  ...
  [
    ...
    { titulo: "Quem ficou para trás", texto: "Apenas 11,3% dos respondentes dizem que a IA não é prioridade na empresa, contra 28,8% duas edições atrás." },
  ],
  "Fonte: State of Data Brazil. A pergunta é respondida por quem trabalha em empresa: bases de 896, 1.045 e 652 respostas válidas.");
...
slideGrafico("Adoção de inteligência artificial",
  ...
  [
    ...
    { titulo: "Onde o mercado está parado", texto: "Os pilotos sem impacto declarado somam 38,4%. Com os 15,0% ainda em planejamento, mais da metade do mercado não saiu da experimentação." },
...
// =====================================================================
{
  ...
  const recs = [
    ...
    },
    {
      ...
      d: "Seis em cada dez respondentes dizem que a empresa já priorizou IA, mas apenas 26,5% declaram projetos em produção gerando resultado. A vantagem competitiva não está mais em adotar, e sim em sair do piloto, o que depende de gente treinada dentro de casa.",
    },
    {
      r: "INVESTIR",
...
// =====================================================================
{
  ...
  rodape(s, "Fonte: apuração própria sobre a camada Gold, reproduzível pelos notebooks e consultas SQL entregues.");
  s.addNotes("Declarar a limitação antes que alguém pergunte é o que separa análise de opinião.");
}

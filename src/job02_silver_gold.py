...
def tabela_distribuicoes(silver):
    ...
    for coluna, pergunta in DISTRIBUICOES.items():
        ...
        cont = (
            ...
            # 4 casas, e nao 2: o rotulo arredonda para 1 casa, e arredondar duas vezes
            # desloca o valor (17,4465 vira 17,45 e depois 17,5, em vez de 17,4)
            .withColumn("participacao_pct", F.round(F.col("respondentes") / F.col("total_validos") * 100, 4))
...
def tabela_cruzamentos(silver):
    ...
    for d1, d2, pergunta in CRUZAMENTOS:
        ...
        cont = (
            ...
            .withColumn("participacao_pct", F.round(F.col("respondentes") / F.col("total_no_grupo") * 100, 4))
...
def tabela_mencoes(silver):
    ...
    for coluna in H.CONCEITOS_MULTIPLA_ESCOLHA:
        ...
        cont = (
            ...
            .withColumn("mencoes_pct", F.round(F.col("mencoes") / F.col("respondentes_pergunta") * 100, 4))
            .withColumn("dimensao", F.lit(coluna))

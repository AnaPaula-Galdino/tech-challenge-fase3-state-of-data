...
Rampa monocromatica azul, sequencial e nao categorica: os tres passos
codificam a edicao da pesquisa, que e uma variavel ordinal, portanto a ordem
visual precisa acompanhar a ordem da variavel.

Validacoes executadas sobre a rampa:
